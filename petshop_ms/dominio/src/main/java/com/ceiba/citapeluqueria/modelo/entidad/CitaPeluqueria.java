...
public class CitaPeluqueria {
	...
	public CitaPeluqueria(Long id, @NonNull Peluquero peluquero, @NonNull List<ServicioPeluqueria> servicios,
			@NonNull Date fechaInicio, @NonNull Usuario usuario, @NonNull String fotoMascota,
			@NonNull Float pesoMascota) throws PesoNoAceptadoException, FechaInicioCitaInvalidaException {
